...
<body class="dash-board">
    ...
    <?php $ret=mysqli_query($con,"select *from   tblvehicle where Status=''"); $cnt=1; while ($row=mysqli_fetch_array($ret)) {?>
            ...
            <td><a style="text-decoration:underline; color:blue" href="view-incomingvehicle-detail.php?viewid=<?php echo $row['ID'];?>">View</a> |
